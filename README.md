...
1. Federated credential to allow `someone@example.com` to exchange a GH actions token for a temporary Plural token.  This token should have at least the scope `catalog.write` or `createPullRequest`.
